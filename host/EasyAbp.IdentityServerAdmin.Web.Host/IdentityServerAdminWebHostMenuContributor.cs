...
{
    public class IdentityServerAdminWebHostMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public IdentityServerAdminWebHostMenuContributor(IConfiguration configuration)
        {
        ...
        private void AddLogoutItemToMenu(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<IdentityServerAdminResource>();
